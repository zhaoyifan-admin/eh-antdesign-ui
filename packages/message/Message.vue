...
<template>
  <div class="eh-message-wrap" :style="`top: ${messTop};`">
    <TransitionGroup name="slide-fade">
      <div class="eh-message" v-show="showMessage[index]" v-for="(message, index) in messageContent" :key="index">
        <div class="eh-message-content" @mouseenter="onEnter(index)" @mouseleave="onLeave(index)">

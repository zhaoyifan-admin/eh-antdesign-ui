...
<template>
  <div class="eh-input-wrap" :style="`width: ${inputWidth};`">
    <span class="eh-addon" :class="{before: showBefore}" v-if="showBefore">
    ...
    <div
      ...
      tabindex="1">
      <span class="eh-prefix" v-if="showPrefix">
      ...
      <input
        ...
        @keydown="onKeyboard"
        v-bind="$attrs" />
      <span class="eh-suffix" v-if="showSuffix">
        <span class="eh-action" v-if="!disabled&&allowClear&&value" @click="onClear">
        ...
        <span class="eh-action" v-if="password" @click="onPassword">
        ...
        <span class="eh-count" v-if="showCount">{{ showCountNum }}</span>
        <slot name="suffix">{{ suffix }}</slot>
      </span>
    </div>
    <span class="eh-addon" :class="{after: showAfter}" v-if="showAfter">

        ...
        <div
          ...
          <div
            ...
            <div class="eh-dialog-header">
              ...
              <span class="eh-screen" @click="onFullScreen" v-if="switchFullscreen" title="缩放">
              <svg v-show="!fullScreen" class="u-svg" viewBox="64 64 896 896" data-icon="fullscreen" aria-hidden="true"
              ...
              <svg v-show="fullScreen" class="u-svg" viewBox="64 64 896 896" data-icon="fullscreen-exit"
              ...
              <span class="eh-close" @click="onClose">
                <svg class="u-svg" viewBox="64 64 896 896" data-icon="close" aria-hidden="true" focusable="false"><path

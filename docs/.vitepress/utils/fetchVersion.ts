/*
  ...
  return fetch('https://api.github.com/repos/themusecatcher/eh-antdesign-ui/contents/package.json?ref=master', {
    headers: {
  ...
  return fetch('https://raw.githubusercontent.com/themusecatcher/eh-antdesign-ui/master/package.json')
*/
